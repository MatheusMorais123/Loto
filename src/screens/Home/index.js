  ...
  return (
    <ScrollView>
      ...
      <View style={styles.container}>
        ...
        {fotoComprovanteSitae ? (
          ...
          >
            <View style={styles.rowContainer}>
              ...
              <Icon name="camera" size={20} color="blue" style={{ marginLeft: 8 }} />
            </View>
          </TouchableOpacity>
        )}
        ...
        <View style={styles.buttonContainer}>
          {enviando ? (
            // Estrutura quando o botão está ativo
            <View style={[styles.button, { backgroundColor: '#999' }]}>
              <Text style={styles.buttonText}>Aguarde...</Text>
            </View>
          ) : (
            // Estrutura padrão do botão
          ...
          {/* Indicador de atividade (spinner) enquanto envia */}
          {/* {enviando && <ActivityIndicator size="small" color="#0000ff" />} */}
        </View>
